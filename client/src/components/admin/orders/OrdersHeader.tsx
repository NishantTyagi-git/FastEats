...
export default function OrdersHeader() {
    return (
        <section className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <p className="text-sm font-medium uppercase tracking-[3px] text-orange-500">Orders</p>

                <h1 className="mt-2 text-4xl font-black text-white">Order Management</h1>

                <p className="mt-2 text-zinc-500">Manage, track and update customer orders.</p>
            </div>

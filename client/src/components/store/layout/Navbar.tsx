    ...
    return (
        <header
            className={`fixed inset-x-0 top-0 z-50 transition-all duration-500 ${isHome ? scrolled
                ...
                : "border-b border-white/10 bg-black/70 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,.22)] "
                }`}
        >
            <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-8">
                ...
                <div className="hidden w-60 items-center justify-end gap-8 lg:flex">
                    ...
                    <Link
                        href="/login"
                        className="flex h-11 items-center gap-2 rounded-full bg-orange-500 px-6 font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-orange-600"
                    >

...
export default function CheckoutSummary() {
    ...
    return (
        <aside className="sticky top-28 self-start rounded-[32px] border border-white/10 bg-[#151515] p-8">
            ...
            <Link
                href="/order-success"
                className="flex h-16 w-full items-center justify-center gap-3 rounded-full bg-orange-500 text-lg font-bold text-white shadow-[0_15px_35px_rgba(249,115,22,.35)] transition-all duration-300 hover:-translate-y-1 hover:bg-orange-600"
            >
                Place Order
                <ArrowRight size={20} />
            </Link>
